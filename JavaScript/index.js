...
function calculateBMI() {
  ...
  // BMI CALCULATION FIELD CHECK
      ...
      if (bmi < 18.6)
          result.innerHTML =  
          `<h1 style="color: blue;">${bmi}</h1>
					<p>Berat Badan Anda <span><u>KURUS</u></span></p>
          <a href="#" class="button">Download Hasil BMI</a>`;

      else if (bmi >= 18.6 && bmi < 24.9) 
          result.innerHTML = 
          `<h1 style="color: green;">${bmi}</h1>
					<p>Berat Badan Anda <span><u>NORMAL</u></span></p>
          <a href="#" class="button">Download Hasil BMI</a>`;

      else if (bmi >= 25 && bmi < 29.9) 
          result.innerHTML = 
          `<h1 style="color: orange;">${bmi}</h1>
					<p>Berat Badan Anda <span><u>GEMUK</u></span></p>
          <a href="#" class="button">Download Hasil BMI</a>`;

      else result.innerHTML =
          `<h1 style="color: red;">${bmi}</h1>
					<p>Berat Badan Anda <span><u>TERLALU GEMUK</u></span></p>
          <a href="#" class="button">Download Hasil BMI</a>`;
      ...
      if (bmi < 18.6)
          ...
          <p>Anda berada dalam kategori : <strong>HEALTHY</strong>.<br />
          ...
          <p>Anda berada dalam kategori : <strong>OBESITAS (OBESE)</strong>.<br />
